...
describe('QuizQuestion Component', () => {
  it('imports QuizQuestionButton.js from QuizQuestionButton.js @quiz-question-component-imports-quiz-question-button-component', () => {
    ...
    ast['program']['body'].forEach(element => {
      if (element.type == 'ImportDeclaration') {
        if (element.source.value == './QuizQuestionButton.js' || element.source.value == './QuizQuestionButton.js' || element.source.value == 'QuizQuestionButton') {
          assert(element.specifiers[0].local.name == 'QuizQuestionButton', "You're not importing the QuizQuestionButton.js class from the QuizQuestionButton.js file.")
